...
const demoProducts: Product[] = [
  {
    id: "prod_001",
    shop_id: demoShop.id,
    product_name: "Sweat Aero Knit",
    price: 5800,
    category: "mode-accessoires",
    image_1: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&w=900&q=85",
    product_description: "Molleton épais et doux, coupe structurée et finitions nettes.",
  ...
  },
  {
    id: "prod_002",
    shop_id: demoShop.id,
    product_name: "Sac bandoulière Orbit",
    price: 6400,
    category: "mode-accessoires",
    image_1: "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&w=900&q=85",
    product_description: "Format compact du quotidien avec texture résistante et détails premium.",
    product_name_translations: {
  ...
  },
  {
    id: "prod_003",
    shop_id: demoShop.id,
    product_name: "Sneakers Studio Runner",
    price: 12800,
    category: "sport",
    image_1: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=900&q=85",
    product_description: "Amorti léger et lignes modernes pour bouger toute la journée.",
    product_name_translations: {
  ...
  },
  {
    id: "prod_004",
    shop_id: demoShop.id,
    product_name: "Sac week-end Minimal",
    price: 14600,
    category: "mode-accessoires",
    image_1: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=900&q=85",
    product_description: "Sac de voyage élégant, volume généreux et doublure douce.",
    product_name_translations: {
  ...
  },
  {
    id: "prod_005",
    shop_id: demoShop.id,
    product_name: "T-shirt coton Luxe",
    price: 4200,
    category: "mode-accessoires",
    image_1: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=900&q=85",
    product_description: "T-shirt du quotidien en coton dense, coupe souple et raffinée.",
    product_name_translations: {
      en: "Luxe Cotton Tee",
      ar: "تيشيرت قطن Luxe",
    },
  ...
  },
  {
    id: "prod_006",
    shop_id: demoShop.id,
    product_name: "Gourde acier mat",
    price: 3800,
    category: "maison",
    image_1: "https://images.unsplash.com/photo-1602143407151-7111542de6e8?auto=format&fit=crop&w=900&q=85",
    product_description: "Acier isotherme double paroi dans une silhouette minimaliste.",
    product_name_translations: {
